...
class DQN_Agent:
    ...
    def __init__(self, seed, layer_sizes, lr, sync_freq, exp_replay_size):
        ...
        # changed Tanh to Relu, bias to False
    ...
    # ======================New helper function======================
    # def get_params(self):
    #     list_of_params=[[] for _ in range(len(layer_sizes))]
    #     for 
...
exp_replay_size = 256
# original seed 1423
agent = DQN_Agent(seed = 0, layer_sizes = [input_dim, 64, output_dim], lr = 1e-3, sync_freq = 5, exp_replay_size = exp_replay_size)
...
# ========check params============
# ================================
# agent_param = list(agent.parameters())
for i in range(len(agent.q_net)):
    if (i%2==0):
        print("layer",i,"shape:",agent.q_net[i].weight.size())
        print(agent.q_net[i].weight)
# ================================
...
plt.show()
# ================================
# Following used to generate video
# ================================
# env = gym.make('CartPole-v0')
